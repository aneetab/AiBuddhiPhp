    ...
    <div class="sufee-login d-flex align-content-center flex-wrap">
        <div class="container">
            <div class="login-content">
                ...
                <h5 class="text-center text-uppercase my-2"><?php echo "Welcome, ".$_SESSION['USER_EMAIL']." !"?></h5>
                    <form method="post">
                    <div class="form-group">
                        ...
                        <button type="submit" name="submit" class="btn btn-dark btn-flat m-b-30 m-t-30">Continue</button>
