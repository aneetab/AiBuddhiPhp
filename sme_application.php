...
if(isset($_SESSION['USER_LOGIN']) && $_SESSION['USER_LOGIN']!='')
{
  ...
  $id=$row[0]['client_id'];
  $profile_img=$row[0]['profile_photo'];
  $_SESSION['USER_ID']=$id;
}
else{
...
$sqlenterprise="select * from sort_by where type='enterprise'";
$enterprises=get_data($con,$sqlenterprise);
...
<?php if(!empty($msg)):?>
                        <div class="alert <?php echo $css_class;?>" id="msg">
                        <?php echo $msg;?>
                        </div>
 <?php endif; ?>
  ...
  <!--INTRODUCTION SECTION-->
    ...
    <form class="form-container" id="mainform" action="" method="post" enctype="multipart/form-data">
    <section>
        <div class="container profile-info">
            <h3>Profile</h3>
                    <div>
                        ...
                        <div class="form-group">
                        <label class="label" for="file">Profile Pic<span style="font-weight:bold;color:#800000">&nbsp;(Image should be in png,jpg or jpeg format)</span>:</label>
    ...
    <section>
        <div class="container languages">
            <h3>Languages</h3>
                            ...
                            <div class="form-group">
                            <label class="label" for="industry">Industry of expertise:</label>
                    <?php
                    ...
                    <?php 
                        ...
                        <option value="other">Other</option>
                            ...
                            <div class="form-group">
                             ...
                             <!--
                             <?php 
                             //while( $enterprise_rows=mysqli_fetch_assoc($enterprise))
                             //echo "<option value=".$enterprise_rows['name'].">".$enterprise_rows['name']."</option>";
                             ?>-->
                             </select> 
    ...
    <section>
        <div class="container video-container">
            ...
            <h4>Record a short subject matter expert profile video.</h4>
                    ...
                    <div>
                                 <div class="form-group">
                                <label class="label" for="video">Link to introduction video&nbsp;<span style="font-weight:bold;color:#800000">(Video should be in mp4 format)</span>:</label>
    ...
    <section>
        <div class="container photo-id">
            ...
            <h4>Please upload a government ID(passport,driver's license or other form of governmental identity card) verifying your identity.</h4>
             <div class="form-group">
             <label class="label" for="photo-id">Upload photo&nbsp;<span style="font-weight:bold;color:#800000">(Image should be in png,jpg or jpeg format)</span>:</label>
...
var enterprise=<?php echo json_encode($enterprises);?>;
...
var select2=document.getElementById('enterprise');
enterprise.forEach(function (obj, i) {
    select2.appendChild(new Option(obj.name, obj.name));
});
...
$('#mainform').on('submit',function(event){
      ...
      form_data.append('email_to',email_to);
       form_data.append('id',id);
       form_data.append('to_name',to_name);
       ...
       $.ajax({
          ...
          if(data==='No')
          {
            ...
            $('#msg').html('Error submitting application.Please try again after some time');
          }
